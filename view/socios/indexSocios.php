        ...
        <div class="col-6 mt-5">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="createSocios.php"><button type="button" class="btn btn-success" style="margin-left:450px;">Agregar</button></a>
                </div>
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110 pd-5" style="margin:20px">
